...
function [Grid_param_auto,Ratemap] = analyze_auto(TRAJ,SPIKE_LOC,Sigma_kernel,Init_param_c1)
...
elseif nargin == 3
    ...
    subplot(141);
    plot(TRAJ(:,1),TRAJ(:,2),'color',[.4 .4 .4],'markersize',1); hold on;
    plot(SPIKE_LOC(:,1),SPIKE_LOC(:,2),'r.','markersize',3); 
